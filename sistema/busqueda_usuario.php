...
<div class="container">
    ...
    <div class="recent-orders">
        ...
        <table>
            ...
            $sql_register = mysqli_query($conexion, "SELECT COUNT(*) AS total_registro FROM usuario WHERE (idusuario LIKE '%$busqueda%' OR nombre LIKE '%$busqueda%' OR correo LIKE '%$busqueda%' OR usuario LIKE '%$busqueda%'  $rol ) AND estatus = 1");
