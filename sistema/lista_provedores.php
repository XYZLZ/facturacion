...
<body>
    ...
    <div class="modal-content">
        ...
        <h5 class="modal-title" id="exampleModalLabel">Registro Provedores</h5>
    ...
    <div class="modal-body">
        <form id="userForm">
            ...
            <div class="mb-3">
                <input type="text" name="provedor" id="provedor" placeholder="Nombre del provedor" class="form_input">
            </div>
            <div class="mb-3">
                <input type="text" name="contacto" id="contacto" placeholder="Nombre Completo del contacto" class="form_input">
            </div>
            <div class="mb-3">
                <input type="number" name="telefono" id="telefono" placeholder="Telefono" class="form_input">
            </div>
            <div class="mb-3">
                <input type="text" name="direccion" id="direccion" placeholder="Direccion Completa" class="form_input">
            </div>
...
<div class="container">
    ...
    <div class="recent-orders">
        ...
        <table>
            ...
            $sql_register = mysqli_query($conexion, "SELECT COUNT(*) AS total_registro FROM proveedor WHERE estatus = 1");
...
<div class="right">
    ...
    <script src="js/provedores.js" type="module"></script>
