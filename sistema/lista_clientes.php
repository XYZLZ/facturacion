...
<body>
    ...
    <div class="modal-body">
        <form id="userForm">
            ...
            <div class="mb-3">
                <input type="number" name="nit" id="nit" placeholder="Numero de NIT" class="form_input">
            </div>
            <div class="mb-3">
...
<div class="container">
    ...
    <div class="recent-orders">
        ...
        <table>
            ...
            $sql_register = mysqli_query($conexion, "SELECT COUNT(*) AS total_registro FROM cliente WHERE estatus = 1");
